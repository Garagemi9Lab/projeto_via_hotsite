                ...
                <div class="form download d-none">
                    ...
                    <form method="post" action="{{ route('leed') }}" id="download">
                        ...
                        <div>
                            ...
                            <a href="{{ asset('via/assets/pdf/tornar-se-dono-do-proprio-negocio.pdf') }}" download id="pdf" hidden>pdf</a>
                        </div>
                    </form>
                </div>
                ...
                <div class="form download d-block">
                    <form method="post" action="{{ route('leed') }}" id="download">
                        <div>
                            ...
                            <a href="javascript:void(0)" class="show-fields">Baixar agora</a>
                            <a href="{{ asset('via/assets/pdf/Checklist.pdf') }}" download id="pdf" hidden>pdf</a>
                        </div>
                    </form>
                </div>
            </div>
