    ...
    <div id="sliders" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="item active">
                <div class="slider bg" style="background: url(<?php echo $urlTema ?>/assets/images/banner1.jpg); center center no-repeat;background-size: cover;">  
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
            ...
            <div class="item">
                <div class="slider bg" style="background: url(<?php echo $urlTema ?>/assets/images/banner2.jpg); center center no-repeat;background-size: cover;">  
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <h2>Gestão empresarial</br><b> moderna e 100% digital</b></h2>
                            </div>
                        </div>
                    </div>
                </div>	
            ...
            <div class="item">
                <div class="slider bg" style="background: url(<?php echo $urlTema ?>/assets/images/banner3.jpg); center center no-repeat;background-size: cover;">  
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
